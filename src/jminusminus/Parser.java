...
public class Parser {
    ...
    private JExpression assignmentExpression() { 
        ...
        if (have(ASSIGN)) {
            ...
            return new JMinusAssignOp(line, lhs, assignmentExpression());           /*Jminus*/
        } else {
            return lhs;
        }
    }
    ...
    private JExpression multiplicativeExpression() {
        ...
        while (more) {
            if (have(STAR)) {
            	...
            	lhs = new JDivideOp (line , lhs , unaryExpression ());			/*DIV node*/
            } else if (have(MOD)) {
        		lhs = new JModOp (line , lhs , unaryExpression ());            /*MOD node*/
        	}
            else {
                more = false;
            }
